...
export const TOOLS: Tool[] = [
  {
    ...
    tags: ["Recon", "Network", "CLI"], install: "sudo apt install nmap", roadmap: { field: "ネットワーク", step: "L3 Nmap で探索" }, terms: ["network", "osint", "pentest"],
  ...
  },
  {
    ...
    tags: ["Web", "Proxy", "GUI"], install: "# Kaliに標準搭載 (burpsuite)", roadmap: { field: "Web", step: "L4 Burp で複合攻撃" }, terms: ["web", "xss", "sqli"],
  ...
  },
  {
    ...
    tags: ["Exploit", "Framework"], install: "sudo apt install metasploit-framework", roadmap: { field: "Pwn / バイナリ", step: "L5 任意コード実行" }, terms: ["exploit", "rce", "payload"],
  ...
  },
  {
    ...
    tags: ["Hash", "GPU"], install: "sudo apt install hashcat", roadmap: { field: "暗号", step: "L3 古典暗号を解く" }, terms: ["hash", "bruteforce"],
  ...
  },
  {
    ...
    tags: ["SQLi", "Auto"], install: "sudo apt install sqlmap", roadmap: { field: "Web", step: "L3 XSS / SQLi" }, terms: ["sqli", "web"],
  ...
  },
  {
    ...
    tags: ["Brute", "Dir"], install: "sudo apt install gobuster", roadmap: { field: "Recon / OSINT", step: "L3 攻撃面の特定" }, terms: ["fuzzing", "web", "osint"],
  ...
  },
  {
    ...
    tags: ["PCAP", "GUI"], install: "sudo apt install wireshark", roadmap: { field: "フォレンジック", step: "L3 パケット復元" }, terms: ["network", "mitm", "forensic"],
  ...
  },
  {
    ...
    tags: ["Hash", "Crack"], install: "sudo apt install john", roadmap: { field: "暗号", step: "L2 ハッシュと衝突" }, terms: ["hash", "bruteforce"],
  ...
  },
  {
    ...
    tags: ["Fuzz", "Web"], install: "go install github.com/ffuf/ffuf/v2@latest", roadmap: { field: "Recon / OSINT", step: "L3 攻撃面の特定" }, terms: ["fuzzing", "web"],
  ...
  },
  {
    ...
    tags: ["Web", "Scan"], install: "sudo apt install nikto", roadmap: { field: "Web", step: "L2 HTTP と改ざん" }, terms: ["web", "vuln"],
  ...
  },
  {
    ...
    tags: ["Memory", "DFIR"], install: "pip install volatility3", roadmap: { field: "フォレンジック", step: "L5 メモリ解析でマルウェア再現" }, terms: ["forensic", "malware", "incident"],
  ...
  },
  {
    ...
    tags: ["Brute", "Login"], install: "sudo apt install hydra", roadmap: { field: "Web", step: "L5 認証バイパスで侵入完遂" }, terms: ["bruteforce", "mfa"],
